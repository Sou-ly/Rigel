...
class SunModelTest {
    ...
    void sunEclipticPosIsCorrectForKnownValues() {
        ...
        assertEquals(1.3004346539729514, ecl1.lon(), 1e8);
        assertEquals(3.4599344864383497, ecl2.lon(), 1e8);
        assertEquals(4.894296774140312, ecl3.lon(), 1e8);
        assertEquals(0.12962120393768117, ecl4.lon(), 1e8);
